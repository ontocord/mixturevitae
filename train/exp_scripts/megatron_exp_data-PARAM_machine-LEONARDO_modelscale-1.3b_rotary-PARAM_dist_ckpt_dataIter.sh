...
EXP_LABEL="open-sci-ref_model-1.3b_data-${DATA_NAME}_samples-${TOTAL_TOKENS_LABEL}_global_bs-${GLOBAL_BATCH_SIZE}_context-${SEQ_LENGTH}_rotary-${ROTARY_BASE}_schedule-${LR_DECAY_STYLE}_lr-${LR}_warmup-${LR_WARMUP_ITERS}"
