...
def generate_addition_problems2(number_of_samples):
    ...
    for i in range(number_of_samples):
        for j in range(number_of_samples):
            a = random.randint(i - 100, i - 10)
            b = random.randint(j - 100, j - 10)
...
def generate_subtraction_problems2(number_of_samples):
    ...
    for i in range(number_of_samples):
        for j in range(number_of_samples):
            a = random.randint(i -100, i - 50)
            b = random.randint(j -100, j - 50)
...
def generate_power_problems(number_of_samples):
    ...
    for i in range(number_of_samples):
        for j in range(number_of_samples):
            a = random.randint(i -20, i - 10)
            b = random.randint(j -20, j - 10)
            try:
                result = a ** b
            except:
                continue
...
def generate_division_problems(number_of_samples):
    ...
    for i in range(number_of_samples):
        for j in range(number_of_samples):
            a = random.randint(i - 1000, i - 100)
            b = random.randint(j - 1000, j - 100)
...
def generate_exponential_with_2_numbers_problems(number_of_samples):
    ...
    for _ in range(number_of_samples):
        if random.randint(0,1):
            a = random.randint(-10,10) / 100
            b = random.randint(0,3) / 20
        elif random.randint(0,1):
            a = random.randint(-100,100) / 100
            b = random.randint(0,5) / 20
        elif random.randint(0,1):
            a = random.randint(-1000,1000) / 100
    ...
    for _ in range(number_of_samples):
        try:
            ...
            for _ in range(num_operands):
                if random.randint(0,1):
                    operands.append(random.randint(-100, 100))  # reduce the range to make computations faster
                else:
...
def generate_fraction_problems(num_problems):
    ...
    def generate_fraction_problem():
        if random.randint(0,1):
            numer1 = random.randint(1, 10)
            denom1 = random.randint(1, 10)
            numer2 = random.randint(1, 10)
...
def sales_commission(n_samples):
    ...
    for _ in range(n_samples):
        if random.randint(0,1):
            sales = random.randint(1001, 2000)
            salery = random.randint(200, 1001)
            gross_pay = salery + (0.02 * (sales - 40))
        else:
...
names = list(set(["Emma", "Olivia", "Ava", "Isabella", "Sophia", "Mia", "Charlotte", "Amelia", "Harper", "Evelyn", "Abigail", "Emily", "Elizabeth", "Mila", "Ella", "Avery", "Sofia", "Camila", "Aria", "Scarlett"] + ['Asaf', 'Alexander', 'David', 'Sarah', 'Sophie', 'George'] +  ["Emma", "Sophia", "Ava", "Mia", "Charlotte", "Amelia", "Olivia", "Harper", "Evelyn", "Abigail"] +  ["Sofia", "Emma", "Jackson", "Olivia", "Aiden", "Mia", "Ethan", "Isabella"] +  ['Alice', 'Bob', 'Charlie', 'David', 'Eve'] +  ['Alice', 'Bob', 'Charlie', 'David', 'Eva', 'Frank', 'Grace', 'Helen', 'Igor', 'Jill']))
...
def sales_clerk_salary(n_samples):
    ...
    for i in range(n_samples):
        ...
        if random.randint(0,1):
            ...
            threshold = random.randint(300, 500)
            sales = random.randint(threshold + 1, 1000)
        else:
...
def sales_commission2(n_samples):
    ...
    for i in range(n_samples):
        name = random.choice(names)
        if random.randint(0,1):
            salary = random.randint(250, 500)
            sales_amt = random.randint(500, 1000)
...
def cookie_problem(n_samples):
    ...
    for i in range(n_samples):
        ...
        if random.randint(0,1):
            total_cookies = random.randint(10, 20)
        else:
...
def department_store(n_samples):
    ...
    for i in range(n_samples):
        name = random.choice(names)
        if random.randint(0,1):
            shirt_price = random.randint(1, 10)
            shoe_price = shirt_price + random.randint(2, 60)
        else:
...
def generate_math_problems(n_samples):
    ...
    for _ in range(n_samples):
        ...
        name2 = random.choice(names)
        if random.randint(0,1):
            notebooks1 = round(random.randint(1, 10), 1)
            notebooks2 = round(random.randint(1, 10), 1)
            erasers1 = round(random.uniform(1, 50), 1)
            erasers2 = round(random.uniform(1, 50), 1)
            total1 = round(random.uniform(10, 50), 1)
            total2 = round(random.uniform(10, 50), 1)
        else:
        ...
        try:
            ...
            print ("problem with generate_math_problems")
            pass
...
def generate_linear_equations_problems(n_samples):
    ...
    for _ in range(n_samples):
        while True: # Loop until we get a valid system of equations
            if random.randint(0,1):
                a1, b1, c1 = random.randint(1, 100), random.randint(1, 100), random.randint(1, 500)
                a2, b2, c2 = random.randint(1, 10), random.randint(1, 10), random.randint(1, 50)
            else:
...
def generate_linear_functions(n_samples):
  def generate_value_table():
    ...
    if random.randint(0,1):
        ...
        x_end = x_start + random.randint(0, 100)
